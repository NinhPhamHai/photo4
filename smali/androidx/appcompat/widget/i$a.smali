...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/appcompat/widget/i;->c()V
.end annotation
...
.method private a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroidx/appcompat/widget/i$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/p0;->a(Landroid/content/Context;I)I
    ...
    .line 8
    invoke-static {v2, p2}, Lc/f/d/a;->b(II)I
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/p0;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v5}, Landroidx/appcompat/widget/p0;->b(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/p0;->a(Landroid/content/Context;I)I
...
.method public a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 15
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/i$a;->d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 17
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/i$a;->c(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 19
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/i$a;->a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 21
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/i$a;->b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, v0, p2}, Landroidx/appcompat/widget/i$a;->a([II)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/p0;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public a(Landroidx/appcompat/widget/k0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/k0;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct {p0, v1, p2}, Landroidx/appcompat/widget/i$a;->a([II)Z
    ...
    .line 45
    invoke-static {p1, v0}, Landroidx/appcompat/widget/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 18
    invoke-direct {p0, p2, v0, v4}, Landroidx/appcompat/widget/i$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 22
    invoke-direct {p0, p2, v0, v3}, Landroidx/appcompat/widget/i$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 26
    invoke-direct {p0, p2, p1, p3}, Landroidx/appcompat/widget/i$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
