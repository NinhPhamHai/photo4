...
.method static a(Lcom/applovin/impl/mediation/b$b;Landroid/content/Context;)Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;
    ...
    invoke-static {p0, p1}, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->a(Lcom/applovin/impl/mediation/b$f;Landroid/content/Context;)Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;

    move-result-object p1

    invoke-virtual {p0}, Lcom/applovin/impl/mediation/b$b;->s()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p1, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->f:Ljava/lang/String;

    invoke-virtual {p0}, Lcom/applovin/impl/mediation/b$b;->r()Ljava/lang/String;
...
.method static a(Lcom/applovin/impl/mediation/b$f;Landroid/content/Context;)Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/applovin/impl/mediation/b$f;->a(Landroid/content/Context;)Z

    move-result v1

    iput-boolean v1, v0, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->b:Z

    invoke-virtual {p0, p1}, Lcom/applovin/impl/mediation/b$f;->b(Landroid/content/Context;)Z

    move-result v1

    iput-boolean v1, v0, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->c:Z

    invoke-virtual {p0, p1}, Lcom/applovin/impl/mediation/b$f;->c(Landroid/content/Context;)Z

    move-result p1

    iput-boolean p1, v0, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->d:Z

    invoke-virtual {p0}, Lcom/applovin/impl/mediation/b$f;->g()Landroid/os/Bundle;
...
.method static a(Lcom/applovin/impl/mediation/b$h;Lcom/applovin/mediation/MaxAdFormat;Landroid/content/Context;)Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;
    .locals 0

    invoke-static {p0, p2}, Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;->a(Lcom/applovin/impl/mediation/b$f;Landroid/content/Context;)Lcom/applovin/impl/mediation/MaxAdapterParametersImpl;
