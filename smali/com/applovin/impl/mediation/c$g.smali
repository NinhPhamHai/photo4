...
# direct methods
.method constructor <init>(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/l;Landroid/app/Activity;Lcom/applovin/mediation/MaxAdListener;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/applovin/impl/mediation/c$g;->g:Ljava/lang/String;

    iput-object p2, p0, Lcom/applovin/impl/mediation/c$g;->h:Lorg/json/JSONObject;

    iput-object p3, p0, Lcom/applovin/impl/mediation/c$g;->i:Lorg/json/JSONObject;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p5}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lcom/applovin/impl/mediation/c$g;->k:Ljava/lang/ref/WeakReference;

    iput-object p6, p0, Lcom/applovin/impl/mediation/c$g;->j:Lcom/applovin/mediation/MaxAdListener;
...
.method private f()V
    ...
    invoke-direct {p0}, Lcom/applovin/impl/mediation/c$g;->h()Lcom/applovin/impl/mediation/b$b;

    move-result-object v0

    iget-object v1, p0, Lcom/applovin/impl/sdk/f$c;->b:Lcom/applovin/impl/sdk/l;

    invoke-virtual {v1}, Lcom/applovin/impl/sdk/l;->c0()Lcom/applovin/impl/mediation/MediationServiceImpl;

    move-result-object v1

    iget-object v2, p0, Lcom/applovin/impl/mediation/c$g;->g:Ljava/lang/String;

    invoke-direct {p0}, Lcom/applovin/impl/mediation/c$g;->g()Landroid/app/Activity;

    move-result-object v3

    iget-object v4, p0, Lcom/applovin/impl/mediation/c$g;->j:Lcom/applovin/mediation/MaxAdListener;
...
.method private g()Landroid/app/Activity;
    ...
    iget-object v0, p0, Lcom/applovin/impl/mediation/c$g;->k:Ljava/lang/ref/WeakReference;
...
.method private h()Lcom/applovin/impl/mediation/b$b;
    .locals 4

    iget-object v0, p0, Lcom/applovin/impl/mediation/c$g;->i:Lorg/json/JSONObject;
    ...
    iget-object v1, p0, Lcom/applovin/impl/mediation/c$g;->h:Lorg/json/JSONObject;

    iget-object v2, p0, Lcom/applovin/impl/mediation/c$g;->i:Lorg/json/JSONObject;

    iget-object v3, p0, Lcom/applovin/impl/sdk/f$c;->b:Lcom/applovin/impl/sdk/l;

    invoke-direct {v0, v1, v2, v3}, Lcom/applovin/impl/mediation/b$e;-><init>(Lorg/json/JSONObject;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/l;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/applovin/impl/mediation/b$d;-><init>(Lorg/json/JSONObject;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/l;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/applovin/impl/mediation/b$c;-><init>(Lorg/json/JSONObject;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/l;)V
...
.method public run()V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/applovin/impl/mediation/c$g;->f()V
    :try_end_0
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/mediation/c$g;->a()Lcom/applovin/impl/sdk/d/i;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/applovin/impl/sdk/d/j;->a(Lcom/applovin/impl/sdk/d/i;)V

    iget-object v0, p0, Lcom/applovin/impl/mediation/c$g;->j:Lcom/applovin/mediation/MaxAdListener;
