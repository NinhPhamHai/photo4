...
.method static a(J)J
    ...
    .line 10
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->a(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method private static a(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 13
    invoke-static {}, Lcom/google/android/material/datepicker/l;->c()Landroid/icu/util/TimeZone;
...
.method static a(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 16
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/l;->a(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
...
.method private static a(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 15
    invoke-static {}, Lcom/google/android/material/datepicker/l;->a()Ljava/util/TimeZone;
...
.method static a(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    .line 2
    invoke-static {p0}, Lcom/google/android/material/datepicker/l;->b(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method static b(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 7
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/l;->a(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method private static d(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
    ...
    .line 2
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/l;->b(Ljava/lang/String;Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method static d()Ljava/util/Calendar;
    ...
    .line 1
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->b(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method static e()Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->d(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
