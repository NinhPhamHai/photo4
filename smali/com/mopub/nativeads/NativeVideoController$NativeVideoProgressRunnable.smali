...
.field private i:Lcom/google/android/exoplayer2/s;

.field private j:Landroid/view/TextureView;

.field private k:Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable$ProgressListener;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Ljava/util/List;Lcom/mopub/common/VisibilityTracker$VisibilityChecker;Lcom/mopub/mobileads/VastVideoConfig;)V
    ...
    iput-object p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->e:Landroid/content/Context;

    .line 8
    iput-object p3, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->g:Ljava/util/List;

    .line 9
    iput-object p4, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->f:Lcom/mopub/common/VisibilityTracker$VisibilityChecker;

    .line 10
    iput-object p5, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->h:Lcom/mopub/mobileads/VastVideoConfig;

    const-wide/16 p1, -0x1

    .line 11
    iput-wide p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->m:J

    const/4 p1, 0x0

    .line 12
    iput-boolean p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->n:Z
...
.method a(Landroid/view/TextureView;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->j:Landroid/view/TextureView;

    return-void
.end method

.method a(Lcom/google/android/exoplayer2/s;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->i:Lcom/google/android/exoplayer2/s;
...
.method a(Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable$ProgressListener;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->k:Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable$ProgressListener;
...
.method a(Z)V
    ...
    .line 6
    iget-object v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->g:Ljava/util/List;
    ...
    .line 8
    iget-object v3, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->f:Lcom/mopub/common/VisibilityTracker$VisibilityChecker;

    iget-object v4, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->j:Landroid/view/TextureView;
    ...
    iget-wide v5, p0, Lcom/mopub/mobileads/RepeatingHandlerRunnable;->d:J
    ...
    .line 13
    :cond_4
    iget-object p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->g:Ljava/util/List;
    ...
    iget-boolean p1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->n:Z
...
.method b()J
    ...
    .line 1
    iget-wide v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->m:J
...
.method c()V
    ...
    .line 1
    iput-boolean v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->n:Z
...
.method public doWork()V
    ...
    .line 1
    iget-object v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->i:Lcom/google/android/exoplayer2/s;

    if-eqz v0, :cond_4

    invoke-interface {v0}, Lcom/google/android/exoplayer2/g0;->b()Z
    ...
    invoke-interface {v0}, Lcom/google/android/exoplayer2/g0;->getCurrentPosition()J
    ...
    invoke-interface {v0}, Lcom/google/android/exoplayer2/g0;->getDuration()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->m:J
    ...
    .line 5
    iget-object v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->k:Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable$ProgressListener;

    if-eqz v0, :cond_1

    .line 6
    iget-wide v1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->l:J

    long-to-float v1, v1

    iget-wide v2, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->m:J
    ...
    .line 8
    :cond_1
    iget-object v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->h:Lcom/mopub/mobileads/VastVideoConfig;

    iget-wide v1, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->l:J

    long-to-int v2, v1

    iget-wide v3, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->m:J
    ...
    .line 16
    :cond_3
    iget-object v0, p0, Lcom/mopub/nativeads/NativeVideoController$NativeVideoProgressRunnable;->e:Landroid/content/Context;
